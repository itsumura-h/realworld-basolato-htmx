...
type GetArticlesInUserQueryDto* = object
  articles*:seq[ArticleDto]

proc new*(_:type GetArticlesInUserQueryDto, articles:seq[ArticleDto]):GetArticlesInUserQueryDto =
  return GetArticlesInUserQueryDto(
    articles:articles
  )
