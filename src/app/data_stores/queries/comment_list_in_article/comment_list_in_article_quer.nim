...
type CommentListInArticleQuery* = object of ICommentListInArticleQuery

proc new*(_:type CommentListInArticleQuery):CommentListInArticleQuery =
  return CommentListInArticleQuery()


method invoke*(self:CommentListInArticleQuery, articleId:ArticleId):Future[CommentListInArticleDto] {.async.} =
  ...
  let dto = CommentListInArticleDto.new(
    comments,
    article
  )
  return dto
